...
class ATM_CLASSNAME : public Machine {
	...
	public:
		...
		enum { EVT_TM_FADE, EVT_TM_ON, EVT_TM_OFF, EVT_CNT_FADE, EVT_CNT_RPT, ELSE, ACT_REPEAT, ACT_OFF, ACT_ON, ACT_UP, ACT_DOWN, ACT_START } IO;
		...
		short pin;
		int repeat_count;
		atm_timer timer_fade, timer_on, timer_off;
